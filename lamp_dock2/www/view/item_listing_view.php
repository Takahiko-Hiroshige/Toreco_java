  ...
  <div class="container">
    ...
    <form 
      ...
      <div class="form-group">
        ...
        <input type="file" name="item_image" id="image" value="<?php if( !empty($_POST['image']) ){ print $_POST['image']; } ?>">
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <?php 
          ...
          <option value="<?php print $category['category_code']?>"><?php print $category['category_name']?></option>
          <?php } ?>
        </select>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <?php 
          ...
          <option value="<?php print $status['status_code']?>"><?php print $status['status_name']?></option>
          <?php } ?>
        </select>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <select id="shipping" name="shipping_code">
          ...
          <option value="<?php print $shipping['shipping_code']?>"><?php print $shipping['shipping_date']?></option>
          <?php } ?>  
        </select>
      </div>
