...
function regist_item($db, $image, $name, $category, $payment, $price, $status, $trade_item_name, $shipping, $introduct, $user_id){
  $filename = get_upload_filename($image);
  if(validate_item($filename, $name, $category, $payment, $price, $status, $trade_item_name, $shipping ,$introduct) === false){
    return false;
  }
  return regist_item_transaction($db, $user_id,$image, $name, $category, $payment, $price, $status, $trade_item_name,$shipping, $introduct, $filename);
}

function regist_item_transaction($db, $user_id, $image, $name, $category, $payment, $price, $status_code, $trade_item_name, $shipping, $introduct, $filename){
  $db->beginTransaction();
  if(insert_item($db, $user_id, $image, $name, $category, $payment, $price, $status_code, $trade_item_name, $shipping, $introduct, $filename) 
...
//function insert_item($db, $user_id, $address, $filename, $name, $category, $payment, $price, $status, $trade_item_name, $shipping, $introduct){
function insert_item($db, $user_id, $address, $name, $price, $category, $status, $shipping, $filename, $introduct, $trade_item_name, $payment){
  ...
  $sql = "
    INSERT INTO
     ...
     VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NOW());
  ";
  return execute_query($db, $sql, array($user_id, $address, $name, $price, $category, $status, $shipping, $filename, $introduct, $trade_item_name, $payment));
}
...
function validate_item($filename, $name, $category, $payment, $price, $status, $trade_item_name, $shipping){
